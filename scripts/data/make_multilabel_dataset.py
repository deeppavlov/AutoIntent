...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, required=True, help="config string like \"[20, 40, 20, 10]\" means 20 one-label examples, 40 two-label examples, 20 three-label examples, 10 four-label examples")
