...
RETRIEVAL_MODULES_MULTICLASS: dict[str, type[Module]] = _create_modules_dict([VectorDBModule])
...
PREDICTION_MODULES_MULTICLASS: dict[str, type[Module]] = _create_modules_dict(
    [ArgmaxPredictor, JinoosPredictor, ThresholdPredictor, TunablePredictor],
)

PREDICTION_MODULES_MULTILABEL: dict[str, type[Module]] = _create_modules_dict(
