from autointent.metrics.retrieval import retrieval_map, retrieval_hit_rate, retrieval_precision, retrieval_ndcg, retrieval_mrr
import numpy as np
import pytest


@pytest.mark.parametrize("query_labels, candidates_labels, k, ground_truth", [
    ([1], [[2, 1, 1]], None, 7 / 12),
    ([3], [[3, 1, 1]], None, 1.0),
