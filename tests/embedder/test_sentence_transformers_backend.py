...
class TestSentenceTransformerBackend:
    ...
    def test_backend_initialization(self, st_backend: SentenceTransformerEmbeddingBackend):
    ...
    def test_model_lazy_loading(self, st_backend: SentenceTransformerEmbeddingBackend):
        ...
        assert embeddings.shape == (1, st_backend._model.get_sentence_embedding_dimension())

    def test_clear_ram(self, st_backend: SentenceTransformerEmbeddingBackend):
    ...
    def test_similarity_function_name(self, st_backend: SentenceTransformerEmbeddingBackend):
    ...
    def test_hash_calculation(self, st_backend: SentenceTransformerEmbeddingBackend):
