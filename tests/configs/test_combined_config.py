            ...
            "search_space": [
                {
                    ...
                    "cross_encoder_config": [
                        {"model_name": "DiTy/cross-encoder-russian-msmarco", "train_head": True},
    ...
    invalid_config = [
        {
            ...
            "search_space": [
                {"module_name": "dnnc", "cross_encoder_name": ["DiTy/cross-encoder-russian-msmarco"], "k": [1, 3]}
            ],
        }
    ]
...
def test_invalid_optimizer_config_wrong_type():
    ...
    invalid_config = {
        ...
        "search_space": [
            {
                "module_name": "dnnc",
                "cross_encoder_name": "DiTy/cross-encoder-russian-msmarco",  # Should be a list
